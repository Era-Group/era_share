{
    ...
    'summary': 'Reassign future activities, leads, meetings, tickets, tasks, quotations and RFQs from one user to another',
    'description': """
...
This module adds a "Reassign Work" action on the user form to transfer:
  ...
  - Draft/Sent purchase orders / RFQs (if Purchase is installed)
