...
class ResConfigSettings(models.TransientModel):
    ...
    era_geo_llms_enabled = fields.Boolean(
        ...
        config_parameter='era_geo.llms_enabled',
        default=True,
    ...
    era_geo_site_summary = fields.Char(
        ...
        config_parameter='era_geo.site_summary',
    ...
    era_geo_llms_max_items = fields.Integer(
        ...
        config_parameter='era_geo.llms_max_items',
        default=100,
    )
    era_geo_llms_include_blog = fields.Boolean(
        string='Include Blog in /llms.txt',
        config_parameter='era_geo.llms_include_blog',
        default=True,
    )
