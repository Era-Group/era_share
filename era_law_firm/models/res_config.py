...
class ResCompany(models.Model):
    ...
    legal_default_city=fields.Char(); legal_hearing_reminder_days=fields.Integer(default=3); legal_deadline_reminder_days=fields.Integer(default=7)
...
class ResConfigSettings(models.TransientModel):
    ...
    legal_deadline_reminder_days=fields.Integer(related='company_id.legal_deadline_reminder_days',readonly=False)
