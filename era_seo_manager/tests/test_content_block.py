...
_SNIPPETS = [
    'era_seo_manager.s_era_faq',
    'era_seo_manager.s_era_cta',
    'era_seo_manager.s_era_author_box',
    'era_seo_manager.s_era_related_posts',
    'era_seo_manager.s_era_breadcrumbs',
    'era_seo_manager.s_era_feature_grid',
    'era_seo_manager.s_era_pricing_table',
]
...
class TestContentBlock(TransactionCase):
    ...
    def test_faq_snippet_has_qa_hooks(self):
        ...
        html = str(self.env['ir.qweb']._render(
            'era_seo_manager.s_era_faq', {'datetime': datetime}))
    ...
    def test_breadcrumbs_snippet_has_list_hook(self):
        html = str(self.env['ir.qweb']._render('era_seo_manager.s_era_breadcrumbs'))
