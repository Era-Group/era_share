...
export class EraspyStatusField extends Component {
    static template = "era_spy_recruitment.EraspyStatusField";
...
registry.category("fields").add("eraspy_status", eraspyStatusField);
