...
class ResConfigSettings(models.TransientModel):
    ...
    tour_assistant_telemetry = fields.Boolean(
        ...
        config_parameter="web_tour_assistant.telemetry",
    ...
    tour_assistant_telemetry_url = fields.Char(
        ...
        config_parameter="web_tour_assistant.telemetry_url",
    ...
    tour_assistant_match_threshold = fields.Float(
        ...
        config_parameter="web_tour_assistant.match_threshold",
    ...
    tour_assistant_generate = fields.Boolean(
        ...
        config_parameter="web_tour_assistant.generate_tours",
