...
class TourTelemetry(models.AbstractModel):
    ...
    def _enabled(self):
        ...
        return (
            setting.get_param("web_tour_assistant.telemetry", "False") == "True"
            and bool(setting.get_param("web_tour_assistant.telemetry_url"))
        )
    ...
    def _snapshot(self):
        ...
        return {
            ...
            "module": self.env["ir.module.module"].sudo().search(
                [("name", "=", "web_tour_assistant")], limit=1).latest_version or "",
    ...
    def send(self):
        ...
        url = self.env["ir.config_parameter"].sudo().get_param(
            "web_tour_assistant.telemetry_url")
        try:
