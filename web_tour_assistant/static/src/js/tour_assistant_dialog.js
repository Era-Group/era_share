...
export class TourAssistantDialog extends Component {
    static template = "web_tour_assistant.AskDialog";
    ...
    async startTour(tour) {
        ...
        browser.localStorage.removeItem("web_tour_assistant.resumed_stage");
        browser.localStorage.removeItem("web_tour_assistant.walked_stage");
